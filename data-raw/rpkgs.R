...
#
# notes:
#   Skips already-installed packages and ensures pccc 1.0.7 tarball is
...
if (!(("pccc" %in% rownames(installed.packages())) && (packageVersion("pccc") == "1.0.7"))) {
  install.packages(pkgs = "pccc/pccc_v2/pccc_1.0.7.tar.gz", repos = NULL, type = "source")
}
