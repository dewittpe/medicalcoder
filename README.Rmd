...
# medicalcoder: `r read.dcf("DESCRIPTION")[1, "Title"]` <img src="man/figures/hex.svg" width="200px" align="right" alt = "medicalcoder hex logo"/>
...
The `mdcr` dataset consists of `r formatC(nrow(mdcr), format = "d", big.mark = " ")` rows.
