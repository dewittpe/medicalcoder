...
The purpose of article is to compare the results for the Charlson comorbidity
...
available from MIT Laboratory for Computational Physilogy (MIT_LCP) on
...
There are there comorbidities were there is are different levels of severify.
...
and indicator for any comorbiditiy.
