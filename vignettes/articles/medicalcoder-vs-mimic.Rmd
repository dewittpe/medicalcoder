...
The SQL file used here is vendored from
...
and is included with the article source at
`vignettes/articles/charlson-mimic-iv/mimic-iv-charlson-278df75.sql`.

```{r}
sql_file <- file.path("charlson-mimic-iv", "mimic-iv-charlson-278df75.sql")
mimic_charson_query <-
  scan(
    file = sql_file,
    what = character(),
