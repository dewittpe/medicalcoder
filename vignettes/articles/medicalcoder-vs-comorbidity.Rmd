...
2. The precompiled codes are built against the intenal ICD database within
   medicalcoder built on ICD-10 codes from the WHO, ICD-9/10-CM from the United
   States Centers for Medicare and Medicaid Services (CMS), and ICD-10-AM
   (Austrialian Modification) from the Independent Health and Aged Care Pricing
   Authority (IHACPA).
