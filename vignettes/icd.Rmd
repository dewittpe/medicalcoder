...
A lookup table for the ICD codes has been built as internal data sets within
the medicalcoder package.  The sources for these lookup tables come from the
