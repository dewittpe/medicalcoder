...
started in the United States in fiscal year 1980. Source information
that could be downloaded from the CDC and CMS and added to the source
code for the medicalcoder package goes back to 1997. As such 1997 is the
"known start"
...
that is 2015. For ICD-10-CM and ICD-10-PCS, which are active, it is just
