...
- Pediatric Complex Chronic Conditions (PCCC)
  ...
  - Version 2.1
    - Updated code base with the same assessment algorithm as version
      2.0.
  - Version 3.0
...
[`comorbidities()`](http://www.peteredewitt.com/medicalcoder/reference/comorbidities.md).
There is support for age scores in Charlson, present on admission flags
for all methods, and support for longitudinal data.
...
additional columns for patient and/or encounter id.
