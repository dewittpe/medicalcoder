...
expected_internal_names_and_classes <-
  list(
    ...
    "..mdcr_internal_charlson_regex.." = c(condition = "character", icdv = "integer", dx = "integer", pattern = "character", charlson_cdmf2019 = "integer", charlson_deyo1992 = "integer", charlson_quan2005 = "integer", charlson_quan2011 = "integer"),
