...
stopifnot(
  t01a = isTRUE("assert_scalar_logical" %in% ls(getNamespace("medicalcoder"), all.names = TRUE)),
  t01b = isTRUE(!("assert_scalar_logical" %in% getNamespaceExports("medicalcoder"))),
  t07a = isTRUE("assert_column" %in% ls(getNamespace("medicalcoder"), all.names = TRUE)),
  t07b = isTRUE(!("assert_column" %in% getNamespaceExports("medicalcoder")))
)
...
stopifnot(
  ...
  inherits(t02e, "error"),
  inherits(t02f, "error"),
  isTRUE(t02c[["message"]] == "The value passed to 'full.codes' is expected to be a length-1 non-missing logical."),
  isTRUE(t02d[["message"]] == "The value passed to 'full.codes' is expected to be a length-1 non-missing logical."),
  isTRUE(t02e[["message"]] == "The value passed to 'full.codes' is expected to be a length-1 non-missing logical."),
  isTRUE(t02f[["message"]] == "The value passed to 'full.codes' is expected to be a length-1 non-missing logical."),
  ...
  inherits(t03e, "error"),
  inherits(t03f, "error"),
  isTRUE(t03c[["message"]] == "The value passed to 'compact.codes' is expected to be a length-1 non-missing logical."),
  isTRUE(t03d[["message"]] == "The value passed to 'compact.codes' is expected to be a length-1 non-missing logical."),
  isTRUE(t03e[["message"]] == "The value passed to 'compact.codes' is expected to be a length-1 non-missing logical."),
  isTRUE(t03f[["message"]] == "The value passed to 'compact.codes' is expected to be a length-1 non-missing logical."),
  ...
  inherits(t04e, "error"),
  inherits(t04f, "error"),
  isTRUE(t04c[["message"]] == "The value passed to 'subconditions' is expected to be a length-1 non-missing logical."),
  isTRUE(t04d[["message"]] == "The value passed to 'subconditions' is expected to be a length-1 non-missing logical."),
  isTRUE(t04e[["message"]] == "The value passed to 'subconditions' is expected to be a length-1 non-missing logical."),
  isTRUE(t04f[["message"]] == "The value passed to 'subconditions' is expected to be a length-1 non-missing logical."),
  ...
  inherits(t05e, "error"),
  inherits(t05f, "error"),
  isTRUE(t05c[["message"]] == "The value passed to 'with.descriptions' is expected to be a length-1 non-missing logical."),
  isTRUE(t05d[["message"]] == "The value passed to 'with.descriptions' is expected to be a length-1 non-missing logical."),
  isTRUE(t05e[["message"]] == "The value passed to 'with.descriptions' is expected to be a length-1 non-missing logical."),
  isTRUE(t05f[["message"]] == "The value passed to 'with.descriptions' is expected to be a length-1 non-missing logical."),
  ...
  inherits(t06e, "error"),
  inherits(t06f, "error"),
  isTRUE(t06c[["message"]] == "The value passed to 'with.hierarchy' is expected to be a length-1 non-missing logical."),
  isTRUE(t06d[["message"]] == "The value passed to 'with.hierarchy' is expected to be a length-1 non-missing logical."),
  isTRUE(t06e[["message"]] == "The value passed to 'with.hierarchy' is expected to be a length-1 non-missing logical."),
  isTRUE(t06f[["message"]] == "The value passed to 'with.hierarchy' is expected to be a length-1 non-missing logical."),
  isTRUE(t08),
  inherits(t09a, "error"),
  inherits(t09b, "error"),
  inherits(t09c, "error"),
