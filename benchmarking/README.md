...
In the following examples, each generated dataset was benchmark by
...
Demo](https://physionet.org/content/mimic-iv-demo/2.2/) dataset provided by
PhysioNet.[^1][^2] Using the MIMIC-IV Clinical Database Demo set will allow others to benchmark
_medicalcoder_ on their system with the same data as used here.
...
The subjects were resampled to generate datasets with up to 1,000,000 subjects.
...
comorbidity. We generated datasets where all subjects on all encounters had at
