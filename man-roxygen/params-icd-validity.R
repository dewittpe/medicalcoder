#' @param year Integer scalar. Fiscal year (CMS), financial year (IHACPA), or
#'   calendar year (WHO, CDC, Socialstyrelsen) to use when determining validity.
#'   If missing, the most recent year available for the given source(s) is used.
#'
